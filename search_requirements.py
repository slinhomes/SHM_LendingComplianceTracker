...
User
the interface runs fine but the database doesn't update as per i wanted. Here is my full code in search_requirements.py. Please check why this is happenening, and correct accordingly
